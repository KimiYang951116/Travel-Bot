...
def handle_location_message(event):
    ...
    if is_agree == 0:
        ...
        if edata == '如何分享位置':
            ...
            multimessage.append(VideoSendMessage(original_content_url='https://youtube.com/shorts/yrloArFh8Sc?feature=share', preview_image_url='https://cdn1.iconfinder.com/data/icons/growth-marketing/48/marketing_video_marketing-512.png'))
        if latlong != 'None':
